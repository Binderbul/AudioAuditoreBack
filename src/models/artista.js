...
const ArtistaSchema = new Schema({//definimos el esquema de los datos
...
module.exports = mongoose.model('Artista', ArtistaSchema);//definimos el modelo de task y le damos el esquema definido, ademas lo exportamos