...
const CancionSchema = new Schema({//definimos el esquema de los datos
...
module.exports = mongoose.model('Cancion', CancionSchema);//definimos el modelo de task y le damos el esquema definido, ademas lo exportamos